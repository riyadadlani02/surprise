...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(e,t,n){return new Pi({name:`SphericalGaussianBlur`,defines:{SAMPLES:ao,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function So(){return new Pi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Co(){return new Pi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wo(),fragmentShader:`
